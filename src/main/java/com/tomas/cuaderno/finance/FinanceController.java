...
@RestController @RequestMapping("/api/finance") public class FinanceController {
    private final FinanceService service; private final FinanceAccountService accounts; private final ExchangeRateService rates;
    public FinanceController(FinanceService service, FinanceAccountService accounts, ExchangeRateService rates) { this.service = service; this.accounts = accounts; this.rates = rates; }

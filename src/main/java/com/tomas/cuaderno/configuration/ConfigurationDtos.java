...
public final class ConfigurationDtos {
    ...
    public record OptionRequest(@NotBlank @Size(max = 80) String code, @NotBlank @Size(max = 160) String label, @Min(0) int sortOrder, boolean active, FinanceItemType financeType) {}
    public record PatchRequest(@Size(max = 160) String label, @Size(max = 16) String emoji, @Min(0) Integer sortOrder, Boolean active, FinanceItemType financeType) {}
